...
var marko_template = module.exports = require('/marko$4.4.27/src/vdom'/*"marko/src/vdom"*/).t(),
    marko_component = {
        onCreate: function() {
          this.state = {
              markdown: "put some text",
              preview: ""
            };
        },
        changeText: function(event) {
          this.state.markdown = event.target.value;

          this.state.preview = this.state.markdown;
        }
      },
    ...
    marko_const_nextId = marko_const("339ba2"),
    marko_node0 = marko_createElement("H1", null, 1, 0, {
        c: marko_const_nextId()
      })
      .t("How to make life a special treat");
...
function render(input, out, __component, component, state) {
  ...
  out.e("DIV", {
    ...
    .e("TEXTAREA", null, 3, 2, {
        onchange: __component.d("changeText"),
        onkeyup: __component.d("changeText")
      })
      .t("\n              ")
      .t(state.markdown)
      .t("\n    ")
